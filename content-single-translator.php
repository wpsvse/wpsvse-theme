...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="project-entry-content clearfix">
				...
				?>
        <div class="project-header"><h2 class="project-entry-title"><?php echo get_avatar( $user_email, 128 ); ?> <a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2></div>
        ...
        <div class="project-editors">
				<?php
					// Find connected translators
					$connected = new WP_Query( array(
						'connected_type' => 'translator_to_projects',
