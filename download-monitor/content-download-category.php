...
<div class="file-info">
	...
	<?php echo $dlm_download->get_the_image( 'thumbnail' ); ?><?php $dlm_download->the_title(); ?> <?php echo $dlm_download->get_the_version_number();?><?php if ( get_post_meta($dlm_download->id, 'dlm_extra_att', true) !== '') { echo ' <p>' . get_post_meta($dlm_download->id, 'dlm_extra_att', true) . '</p>'; } ?></a> - <?php echo $dlm_download->get_the_filesize(); ?>
	<br />
