...
<div class="file-info">
	...
	<?php echo $dlm_download->get_the_image( 'thumbnail' ); ?><?php $dlm_download->the_title(); ?> <?php echo $dlm_download->get_the_version_number();?> <?php the_excerpt(); ?></a> - <?php echo $dlm_download->get_the_filesize(); ?>
	<br />
