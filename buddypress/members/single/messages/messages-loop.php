	...
	<table id="message-threads" class="messages-notices">
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			...
			<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
				...
				<td width="1%" class="thread-avatar"><?php bp_message_thread_avatar( 'width=' . BP_AVATAR_TINY_WIDTH . '&height=' . BP_AVATAR_TINY_HEIGHT ); ?> </td>

				<?php if ( 'sentbox' != bp_current_action() ) : ?>
					<td data-label="Från" width="30%" class="thread-from">
				...
				<td data-label="Meddelande" width="50%" class="thread-info">
				...
				<td data-label="Återgärder" width="13%" class="thread-options">
