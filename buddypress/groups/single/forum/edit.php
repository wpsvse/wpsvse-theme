	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<input class="form-control" type="text" name="topic_title" id="topic_title" value="<?php bp_the_topic_title(); ?>" maxlength="100" />

				<label for="topic_text"><?php _e( 'Content:', 'buddypress' ); ?></label>
				<textarea class="form-control" name="topic_text" id="topic_text"><?php bp_the_topic_text(); ?></textarea>

				<label><?php _e( 'Tags (comma separated):', 'buddypress' ); ?></label>
				<input class="form-control" type="text" name="topic_tags" id="topic_tags" value="<?php bp_forum_topic_tag_list(); ?>" />
		...
		<?php else : ?>
			...
			<div id="edit-post">
				...
				<textarea  class="form-control" name="post_text" id="post_text"><?php bp_the_topic_post_edit_text(); ?></textarea>
