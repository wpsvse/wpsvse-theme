...
function wpsvse_bp_directory_groups_search_form() {
  $search_form_html = '<form action="" method="get" id="search-groups-form">
				...
				<input class="btn btn-primary" type="submit" id="groups_search_submit" name="groups_search_submit" value="'. __( 'Search', 'buddypress' ) .'" />
		</form>';
  return $search_form_html;
}
add_filter('bp_directory_groups_search_form', 'wpsvse_bp_directory_groups_search_form');
